            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h4 class="mb-0"> Purchase Order Summary
                        <a href="purchase-order-create.php" class= "btn btn-danger float-end">Back to create purchase order</a>
                    </h4>
                </div>
                <div class="card-body">
                    <?php alertMessage(); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Customer Name: <?= $iRowData['firstname']; ?></p>
                                                    <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Customer Last Name: <?= $iRowData['lastname']; ?></p>
                                                    <p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">
                                                        Position: 
                                                        <?php 
                                                            echo $iRowData['position'] == 1 ? 'Owner' : 'Employee'; 
                                                        ?>
                                                    </p>
                            ...
                            <div class="table-responsive mb-3">
                                <table style="width:100%;" cellpadding="5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="5">Payment Mode: <?= $_SESSION['ingPayment_mode']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
