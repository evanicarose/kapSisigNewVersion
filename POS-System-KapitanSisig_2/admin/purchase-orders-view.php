    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Purchase Order View
                <a href="purchase-orders.php" class="btn-danger mx-2 btn-sm float-end" style="text-decoration: none;">Back</a>
                    ...
                    <div class="card card-body shadow border-1 mb-4 ">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="mb-1">
                                    Name: <span class="fw-bold"><?= htmlspecialchars($orderData['firstname'], ENT_QUOTES, 'UTF-8'); ?></span>
                                </label>
                                <br/>
                                <label class="mb-1">
                                    Lastname: <span class="fw-bold"><?= htmlspecialchars($orderData['lastname'], ENT_QUOTES, 'UTF-8'); ?></span>
                                </label>
                                <br/>
                                <label class="mb-1">
                                    Position: 
